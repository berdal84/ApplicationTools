...
public:
	...
	/// \return false if an error occurred, in which case any existing file at _path may or may not have been overwritten.
...
private:
	...
	static int        s_rootLengths[kRootTypeCount];
