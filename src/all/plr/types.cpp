...
plr_DataType_convert(signed_change_precision)
{
	using std::numeric_limits;
	if (sizeof(tSrc) >= sizeof(tDst)) {
...
#undef plr_DataType_Convert

template <bool is_src_int, bool is_dst_int, bool is_src_signed, bool is_dst_signed, bool same_size>
struct normalized_convertT{};
#define plr_DataType_dispatch_convert(is_src_int, is_dst_int, is_src_signed, is_dst_signed, same_size) \
	template <typename tSrc, typename tDst> \
...
plr_DataType_dispatch_convert(false, true, true, true, false)
{
	return float_to_signed<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(false, true, true, false, false)
{
	return float_to_unsigned<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(false, true, true, true, true) // float/int same size
{
	return float_to_signed<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(false, true, true, false, true) // float/int same size
{
	return float_to_unsigned<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, false, true, true, false)
{
	return signed_to_float<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, false, false, true, false)
{
	return signed_to_float<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, false, true, true, true) // float/int same size
{
	return signed_to_float<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, false, false, true, true) // float/int same size
{
	return signed_to_float<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, true, true, false, true)
{
	return signed_to_unsigned<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, true, false, true, true)
{
	return unsigned_to_signed<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, true, true, true, false)
{
	return signed_change_precision<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, true, false, false, false)
{
	return unsigned_change_precision<tSrc, tDst>(_src);
}
plr_DataType_dispatch_convert(true, true, true, false, false)
{
...
plr_DataType_dispatch_convert(true, true, false, true, false)
{
...
plr_DataType_dispatch_convert(true, true, true, true, true)
{
	return (tDst)_src;
}
plr_DataType_dispatch_convert(true, true, false, false, true)
{
	return (tDst)_src;
}
#undef plr_DataType_dispatch_convert

template <bool require_normalized>
struct convertT{};
#define plr_DataType_dispatch_convert(require_normalized) \
	template <typename tSrc, typename tDst> \
	inline tDst static convert(tSrc _src, convertT<require_normalized>)
plr_DataType_dispatch_convert(true)
{
	using std::numeric_limits;
...
plr_DataType_dispatch_convert(false)
{
	return (tDst)_src;
}
#undef plr_DataType_dispatch_convert
